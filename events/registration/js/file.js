  ...
  $("#ford").submit(function(){
	 ...
	 $("#register").submit(function(){
		...
		var hit=1;
		 ...
		 if($(":input:eq(8)").val()=="")
		 {
			 $("#regcontact").html('Required');
			 $("#regcontact").show();
			 hit=2;
		 }
		 else
		 {
		 	var us=$("input:eq(8)").val().length;
		 	if(us<10)
		 	{
		 		$("#regcontact").html('Enter a valid Phone No');
		 		$("#regcontact").show();
		 		hit=2;
		 	}	
		 }
